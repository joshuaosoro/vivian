...
Since the data was now available in text form, coding and thematic analysis was done using Nvivo 12 software. The process of coding and analysis is really made a lot easier using Nvivo, @wong2008data. Verbatim quotes from study participants were added to emphasize the findings of the study.
